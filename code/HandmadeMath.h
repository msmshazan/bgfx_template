...
HMM_INLINE hmm_mat4 HMM_OrthographicDX(float Left, float Right, float Bottom, float Top, float Near, float Far)
{
    hmm_mat4 Result = HMM_Mat4();
...
HMM_INLINE hmm_mat4 HMM_PerspectiveDX(float FOV, float AspectRatio, float Near, float Far)
{
    hmm_mat4 Result = HMM_Mat4();
